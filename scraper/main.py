...
def setup_scrapers(db_manager) -> Dict[str, Any]:
    ...
    """
    try:
        # Korrigierte Imports für die neue Paketstruktur
        from scraper.scrapers.ebay_scraper import EbayScraper
        from scraper.scrapers.amazon_scraper import AmazonScraper
...
def main():
    ...
    try:
        ...
        from scraper.gui.gui import EbayScraperGUI  # Korrigierter Import
        from scraper.database.database_manager import DatabaseManager  # Korrigierter Import
        from utils.x11_config import configure_x11_environment, check_display_server  # Korrigierter Import
        ...
        logger.critical(
            f"Kritischer Fehler beim Programmstart: {e}",
            exc_info=True
        )
        try:
